...
class TelaAdministrador(ComponenteBase):
    ...
    def criar_interface(self):
        ...
        title_label = ttk.Label(header_frame, text="Painel do Administrador", 
                              font=("Arial", 16, "bold"))
    ...
    def criar_menu_opcoes(self, parent):
        ...
        for texto, comando in opcoes:
            btn = ttk.Button(parent, text=texto, command=comando, width=20)
    ...
    def gerenciar_financas(self):
        ...
        title = ttk.Label(self.content_frame, text="Gerenciar Finanças", font=("Arial", 14, "bold"))
        title.pack(pady=20)
        
        messagebox.showinfo("Em Desenvolvimento", "Funcionalidade de finanças em desenvolvimento")
